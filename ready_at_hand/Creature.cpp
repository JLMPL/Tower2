...
//     setupAnimator(&m_animator, &gfx::g_MeshMgr.getSkinnedMesh("rigud.dae")->skeleton, *anim::getLoadedBundle("Rigud"));
...
//     // m_animator = anim::addAnimatorToAnimSystem(&gfx::g_MeshMgr.getSkinnedMesh("rigud.dae")->skeleton, "Rigud");
//     // m_meshNode = m_context->renderScene->addRenderSkinnedMesh("rigud.dae", m_animatormatrixPalette.data());
