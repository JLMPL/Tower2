...
//         m_cre->setFacingDirection(math::lerp(m_cre->getFacingDir(), walkDir, timer::delta * 5));

//         m_cre->getCharCtrl().move(walkDir * speed, timer::delta);
//     }
...
// {
//     m_verticalVelocity -= timer::delta * 9.8;
//     m_cre->getCharCtrl().move(vec3(0,m_verticalVelocity,0), timer::delta);
// }
